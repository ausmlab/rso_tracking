...
def main():
    ...
    parser.add_argument('--video_dir', default='./data', help='the directory having each directory of dates')
    ...
    save_dir = './data/{}_mot'.format(args.dataset)
    for video in videos :
        # Make save_directory for images and labels
        save_img_dir = os.path.join(save_dir, video, 'img1')
        save_label_dir = os.path.join(save_dir, video, 'gt')
