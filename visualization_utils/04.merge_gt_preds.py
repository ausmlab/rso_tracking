...
def main():
    ...
    parser.add_argument('--gt', default='./Visualization/GTs', help='the dir of images with annotations on them')
    parser.add_argument('--pred', default='./Visualization/preds', help='the dir of images with predictions on thme')
